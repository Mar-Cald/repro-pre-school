...
::: notes
I’ve been passionate about reproducible science after going through an experience I’m sure many of you can relate to: trying to make sense of an old project with no documentation, no structure, and files named things like “final_version_revised3_bis.csv.” I realized that if I couldn’t understand my own work after a few months, how could I possibly expect others to follow it, replicate it, or build upon it? That’s why I’m here today: to talk about reproducible science, as a concrete way to improve the quality, transparency of our research.
:::
...
::: notes
 Reproducible workflows save time. They reduce errors. They make collaboration smoother. 
:::
...
::: notes
Now, I’ll be honest. Learning to work reproducibly takes effort. It often feels harder at first. It can feel slow and confusing. But once you’ve learned these tools, your workflow becomes smoother, and much easier to maintain. 
:::
...
::: notes
So how do we do this? Let’s start with some concrete recommendations. Use plain-text formats for your data: CSV (.csv) and tab-delimited text (.txt) are ideal. They’re easy to read, easy to import- Avoid Excel files or other proprietary formats that often create compatibility issues. Plain text is portable. It doesn’t care what operating system or software someone uses. 
:::
...
::: {layout-ncol="1"}
![Advanced R](images/advanced-r.jpg){width="200" fig-align="center"} ![Hands-on Programming With R](images/hand-on-programming.jpeg){width="200" fig-align="center"}
:::
...
::: notes
So far, we’ve talked about good data practices, clean code, and functional programming. But now we need to ask: How do we keep everything together, our data, our scripts, our figures, our notes, in a way that is coherent, portable, and reproducible?
:::
...
::: notes
All of this structure isn’t just for you, it makes it easier to work with others. Imagine sending a collaborator your entire project folder. They open it, install renv, run one script, and everything works.
:::
