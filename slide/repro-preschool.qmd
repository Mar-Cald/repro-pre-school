...
::: notes
We need to organize, document, and share our data so it’s clear to others. Our analysis code should be clean, transparent, and reusable. By combining code and explanation in the same document, we make our work dynamic and understandable. And with version control tools like Git, we can track changes, collaborate, and share our work openly.
:::
...
::: notes
So far, we’ve talked about good data practices, clean code, and functional programming. But now we need to ask: Where does all of this live? How do we keep everything together, our data, our scripts, our figures, our notes, in a way that is coherent, portable, and reproducible?
:::
